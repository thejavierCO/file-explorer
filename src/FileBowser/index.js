...
const file_1 = __importDefault(require("../tools/origin/file"));
const dir_1 = __importDefault(require("../tools/origin/dir"));
const is_1 = __importDefault(require("../tools/is"));
const lastElement_1 = __importDefault(require("../tools/lastElement"));
class fileBrowser {
